  ...
  function makeScenarios() {
    ...
    const active = {
      ...
      agents: {
        ...
        "retro-pm": { status: "idle",   lastSeenAt: "4h前" },
      ...
      // post M0.X-skill-migration — recent (echoes) + queued summons
      recentSpirits: [
        { id: "rev-sec",  caption: "secret scan · 12m前" },
        { id: "retro-pj", caption: "retro lens · 1h前" },
      ],
      queuedSpirits: [
        { skill: "loom-retro/stages.aggregator", at: "next retro" },
      ],
      todos: TODOS_BASE,
      todosUpdatedAt: "now",
