...
- [ ] tests/REQUIREMENTS.md REQ-031 追加（verdict_evidence + M0.14 t6/t7 closure 統合） <!-- id: m2.1-t2 status: todo -->
- [ ] agents/loom-retro-pm.md "Verdict 保存 hook" section refactor（独立 file + 5 step lazy build + §6.9.5 参照） <!-- id: m2.1-t3 status: todo -->
- [ ] agents/loom-pm.md "Reviewer verdict 保存" section refactor（PM hint reference のみ、責務分離） <!-- id: m2.1-t4 status: todo -->
- [ ] docs/RETRO_GUIDE.md verdict_evidence 運用 SSoT 章追加 <!-- id: m2.1-t5 status: todo -->
- [ ] docs/DOC_CONSISTENCY_CHECKLIST.md M2.1 セクション追加 + M0.13 line 125 update + M0.14 t6 cleanup 統合 <!-- id: m2.1-t6 status: todo -->
- [ ] tests/agents_test.sh 拡張（retro-pm Stage 0 build step + PM hint 形式 + process-judge 3 新 category schema） <!-- id: m2.1-t7 status: todo -->
- [ ] 全 test PASS (`./tests/run_tests.sh` 8 PASS 維持) + tag m2.1-complete + main merge <!-- id: m2.1-t8 status: todo -->

**M2.1 完成基準**：
- `./tests/run_tests.sh` で **8 PASS** 維持（既存 8 + agents_test 拡張）
